...
function viewDataInTable_H(dataFromFirestore) {
    ...
    dataFromFirestore.forEach((doc) => {
        ...
        td.innerHTML =
            `
            <button type="button" id="`+ id + `" data-toggle="modal" data-target="#editDataModal" onclick="anexoH.renderEditModal('` + id + `')" class="btn btn-success mb-1"><i class="fa fa-edit"></i></button>
            `
...
//the button from "displayDataInTable_h()" was clicked and triggered the "#editDataModal"
const renderEditModal_H = (id) => {
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header inline-block">
                    <h5 class="modal-title">Marcar retorno da viatura</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <p id="showExitTime" class="text font-weight-bold">s</p>
                    </div>
                    <div class="row">
    ...
    anexoH.fetchOneDocForUpdate(id)
